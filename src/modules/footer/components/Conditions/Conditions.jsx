  ...
  return (
    <div className={s.modalContent}>
      <div className={s.topOfModal}>
        <h3 className={s.conditionsTitle}>Умови обробки персональних даних</h3>
      ...
      <ol className={s.conditionsList}>
        <li>
          Під персональними даними, зазначеними в цьому вікні, мається на увазі
          Ваш номер телефону.
        </li>
        <li>
        ...
        <li>
          ...
          метою реєстрації персональних даних Суб&rsquo;єкта у базі даних Сайту
          з метою надсилання Суб&rsquo;єкту персональних даних Промокоду для
          отримання одноразової знижки та додаванням вказаного номеру телефону в
          розсилку цікавих пропозицій від Сайту.
        </li>
        <li>
